import { IonButton, IonCard, IonCol, IonLabel, IonPage, IonRow, IonText } from '@ionic/react'
      ...
      <IonRow className='h-full'>
        ...
        <IonCol size='5'>
          ...
          <IonCol size='12' className='text-center'>
            <IonCard>
              <IonButton expand='block' routerLink='/auth/login'>Log in</IonButton>
              <IonButton expand='block' routerLink='/auth/signup' fill='outline'>Sign up</IonButton>
            </IonCard>
